...
function [saccadetime, fitparams] = detectsaccade_all(timestamp,eyeposition,dataset)
% Median Filter
eyeposition = medfilt1(eyeposition, 10);
...
figname = ['Dataset_', dataset_str, '_mit_allen_Phasen'];
